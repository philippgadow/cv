    ...
    \cventry
      ...
      {2024 -- Present} % Date(s)
      {
        \begin{cvitems} % Description(s) bullet points
          \item {Machine learning algorithms for jet flavour tagging, investigation of Higgs potential through searches for Higgs pair production and Higgs Yukawa coupling to charm quarks, reconstruction algorithms for spherical proportional counters (70\%).}
