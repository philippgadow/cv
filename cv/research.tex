  ...
  {2024 -- Present} % Date(s)
{
  \begin{cvitems} % Description(s)
    ...
    \item \textbf{Main collaborators:} Prof. Kostas Nikolopoulos (University of Hamburg), Prof. Peter Schleper (University of Hamburg), Dr. Robert Ward (University of Hamburg).
  \end{cvitems}
}
%---------------------------------------------------------
%---------------------------------------------------------
