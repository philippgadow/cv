  ...
  {2021 -- Present} % Date(s)
{
  \begin{cvitems} % Description(s)
    ...
    Dr. Michael Kagan (SLAC), Prof. Alessandro Calandri (Firenze), Dr. Alexandre de Moor (Brussels-VUB).
  \end{cvitems}
}
%---------------------------------------------------------
\cventry
  {CMS Experiment} % Experiment
  {Searches for additional light scalars in Higgs-boson decays} % Topic
  {University of Hamburg} % Location
  {2025 -- Present} % Date(s)
{
  \begin{cvitems} % Description(s)
    \item {Search for additional light scalars in Higgs-boson decays via the \(H \rightarrow Za\) channel with hadronic decays of the \(a\)-boson, in both inclusive and exclusive final states.}
    \item \textbf{Scope of Research:} Development of a machine-learning-based event selection, including the setup of an analysis chain for jet tagging and mass regression, as well as the development and validation of a framework for the subsequent data analysis.   
    \item \textbf{Main collaborators:} Prof. Kostas Nikolopoulos (University of Hamburg), Dr. Robert Ward (University of Hamburg).
  \end{cvitems}
}
%---------------------------------------------------------
%---------------------------------------------------------
\cventry
  {CMS Experiment} % Experiment
  {Investigation of Higgs Yukawa Coupling to Bottom and Charm Quarks} % Topic
  {University of Hamburg} % Location
  {2025 -- Present} % Date(s)
{
  \begin{cvitems} % Description(s)
    \item {Investigation of the Yukawa coupling of the Higgs boson to bottom and charm quarks.}
    \item \textbf{Scope of Research:} Involvement in the analysis of VBF Higgs boson production with subsequent decay to \(b\) and \(c\)-quarks, focusing on advanced signal extraction techniques, background modeling, and interpretation of results.  
    \item \textbf{Main collaborators:} Prof. Kostas Nikolopoulos (University of Hamburg), Dr. Angela Zaza (INFN Bari).
  \end{cvitems}
}
%---------------------------------------------------------
\cventry
  {Detector R\&D} % Experiment
  {Muon Reconstruction with Machine Learning in Spherical Proportional Counters} % Topic
  {University of Hamburg} % Location
  {2025 -- ongoing} % Date(s)
{
  \begin{cvitems} % Description(s)
    \item {Spherical proportional counters (SPCs) are novel gaseous detectors with potential applications in future detector technologies. Machine learning techniques enable advanced reconstruction of muon tracks from raw detector signals, improving spatial and angular resolution beyond traditional methods.}
    \item \textbf{Scope of research:} Development of machine learning architectures including deep neural networks (DNNs), convolutional neural networks (CNNs), and attention-based transformer models for muon track reconstruction in SPCs.
    \item \textbf{Main collaborators:} Prof. Kostas Nikolopoulos (University of Hamburg), Dr. Robert Ward (University of Hamburg).
  \end{cvitems}
}
