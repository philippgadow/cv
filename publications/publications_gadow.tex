...
\textit{analysis software maintenance, distributed computing, optimisation studies for $E_{\text{T}}^{\text{miss}}$ significance and jet cleaning}}
...
\section{Selected public notes released by the ATLAS experiment}
